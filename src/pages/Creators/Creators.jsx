    ...
    <main>
      <section>
        <div className='section-first-background flex justify-center items-center'>
          <div className='sm:w-[600px] md:w-[800px] lg:w-[1000px] xl:w-[1310px] lg:container px-20 mx-auto my-24 mt-60 text-center'>
            ...
            <div className='flex md:flex-row flex-col justify-end relative items-center sm:mx-20 xl:mx-60 px-5'>
              <input className='md:text-[22px] md:absolute text-xs w-full md:py-3 px-5 rounded-md border py-[10px] outline-none font-semibold' placeholder='kofe.al/username' type="email" />
      ...
      <section className='px-5'>
        <div className=" min-h-screen bg-gradient-to-br from-purple-700 to-blue-500 text-white flex flex-col items-center justify-center">
          <h1 className="text-3xl font-bold mb-8">Welcome to Cool Page</h1>
